...
- Extended Figure 2.a: ```Gene AM vs PM Overlapping Histogram.ipynb```
- Extended Figure 2.b: ```Gene Diurnality Box Plot.ipynb```
- Extended Figure 3: ```Gene Expression by Subject Over Time.ipynb```
- Extended Figure 3: ```Gene Subject vs All Overlapping Histogram.ipynb```
- Extended Figure 4: ```Gene Subject vs Others Box Plot.ipynb```
- Extended Figure 5: ```Individuality and Cell Type Specificity.ipynb```